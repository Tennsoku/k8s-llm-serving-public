...
| Spark A | `enp1s0f1np1` | IPv4 link-local (redacted) | 200 Gb/s | 1500 | IP-configured data/OOB path and RoCE HCA |
| Spark B | `enp1s0f1np1` | IPv4 link-local (redacted) | 200 Gb/s | 1500 | IP-configured data/OOB path and RoCE HCA |
...
| TCP data baseline | IP-configured `enp1s0f1np1` pair | Canonical four-stream A→B run passed at 96.7404 Gbit/s receiver throughput |
